...
# Macro to reload profile configuration
Set-PSReadLineKeyHandler -Key Ctrl+u `
                         -BriefDescription ReloadProfile `
                         -LongDescription "Reload profile configuration" `
                         -ScriptBlock {
    [Microsoft.PowerShell.PSConsoleReadLine]::RevertLine()
...
# Clipboard interaction is bound by default in Windows mode.
Set-PSReadLineKeyHandler -Key Ctrl+C -Function Copy
Set-PSReadLineKeyHandler -Key Ctrl+v -Function Paste

# Other way to enter in Vi mode
Set-PSReadLineKeyHandler -Key Ctrl+'{' -Function ViCommandMode

# CaptureScreen is good for blog posts or email showing a transaction
# of what you did when asking for help or demonstrating a technique.
Set-PSReadLineKeyHandler -Chord 'Ctrl+i,Ctrl+c' -Function CaptureScreen

# Delete word like Vi in insert mode
Set-PSReadLineKeyHandler -Key Ctrl+w -Function ShellBackwardKillWord

#region Smart Insert/Delete

# The next key handlers are designed to make entering matched quotes
...
Set-PSReadLineKeyHandler -Key "Ctrl+k" `
                         -BriefDescription DeleteLine `
                         -LongDescription "Delete the current line" `
                         -ScriptBlock {
    param($key, $arg)
    [Microsoft.PowerShell.PSConsoleReadLine]::RevertLine()
}
